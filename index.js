...
*[ •  B O T  - R E P O ‎ • ]*
*╭┈───────────────•*
*│✫➠ - 🌐URL:* *https://github.com/Nimeshkamihiran/neno-xmd-bot-V3*
*╰┈───────────────•*
*YOUR WHATSPP BOT RUNING NOW HAPPY💖💞🪄*\n\n*PREFIX: [${prefix}]*
...
//================ownerreact==============
if(senderNumber.includes("94721584278")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("94721584279")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("94721584279")){
...
app.get("/", (req, res) => {
res.send("HEY, NENO XMD V3 STARTED ✅");
});
